 ...
 */
final class Version20250616091751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE poi (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(30) NOT NULL, properties JSON NOT NULL, geometry GEOMETRY DEFAULT NULL COMMENT \'(DC2Type:geometry)\', nom VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
