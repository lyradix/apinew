...
public function postPoi(
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        ...
        // For scene type, we'll handle it via AJAX in SceneController instead
        if ($type === 'scène' && !$request->isXmlHttpRequest()) {
            // If it's not AJAX, show the template with AJAX setup for scenes
