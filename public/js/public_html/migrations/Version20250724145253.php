 ...
 */
final class Version20250724145253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE partners (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(30) NOT NULL, front_page TINYINT(1) NOT NULL, type VARCHAR(30) NOT NULL, link LONGTEXT NOT NULL, partner_id VARCHAR(5) NOT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE poi (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(30) NOT NULL, properties JSON NOT NULL COMMENT \'(DC2Type:json)\', geometry GEOMETRY DEFAULT NULL COMMENT \'(DC2Type:geometry)\', nom VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
